...
Java_com_watermark_utils_StringUtils_calConv1D(JNIEnv *env, jclass instance,
...
Java_com_watermark_utils_StringUtils_stringToBinary(JNIEnv *env, jclass instance,
                                                              jstring inputText_) {
...
Java_com_watermark_utils_StringUtils_stringToIntArray(JNIEnv *env, jclass instance,
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_watermark_utils_StringUtils_binaryToString(JNIEnv *env, jclass instance,
                                                              jstring inputText_) {
    const char *inputText = env->GetStringUTFChars(inputText_, 0);
...
Java_com_watermark_utils_StringUtils_replaceNines(JNIEnv *env, jclass instance,
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_watermark_utils_StringUtils_intArrayToString(JNIEnv *env, jclass instance,
                                                                jintArray inputArray_) {
    jint *inputArray = env->GetIntArrayElements(inputArray_, NULL);
    jsize size = env->GetArrayLength(inputArray_);
    ostringstream oss("");
